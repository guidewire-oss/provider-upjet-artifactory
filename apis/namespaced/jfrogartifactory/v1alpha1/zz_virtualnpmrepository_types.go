...
type VirtualNpmRepositoryInitParameters struct {
...
type VirtualNpmRepositorySpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            VirtualNpmRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualNpmRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualNpmRepositoryStatus defines the observed state of VirtualNpmRepository.
type VirtualNpmRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualNpmRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualNpmRepository is the Schema for the VirtualNpmRepositorys API. <no value>
...
type VirtualNpmRepository struct {
	...
	Spec              VirtualNpmRepositorySpec   `json:"spec"`
	Status            VirtualNpmRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualNpmRepositoryList contains a list of VirtualNpmRepositorys
type VirtualNpmRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualNpmRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualNpmRepository_Kind             = "VirtualNpmRepository"
	VirtualNpmRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualNpmRepository_Kind}.String()
	VirtualNpmRepository_KindAPIVersion   = VirtualNpmRepository_Kind + "." + CRDGroupVersion.String()
	VirtualNpmRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualNpmRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualNpmRepository{}, &VirtualNpmRepositoryList{})
}
