...
type LocalMavenRepositoryInitParameters struct {
...
type LocalMavenRepositoryObservation struct {
...
type LocalMavenRepositoryParameters struct {
...
// LocalMavenRepositorySpec defines the desired state of LocalMavenRepository
type LocalMavenRepositorySpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            LocalMavenRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalMavenRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalMavenRepositoryStatus defines the observed state of LocalMavenRepository.
type LocalMavenRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalMavenRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalMavenRepository is the Schema for the LocalMavenRepositorys API. <no value>
...
// LocalMavenRepositoryList contains a list of LocalMavenRepositorys
type LocalMavenRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalMavenRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalMavenRepository_Kind             = "LocalMavenRepository"
	LocalMavenRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalMavenRepository_Kind}.String()
	LocalMavenRepository_KindAPIVersion   = LocalMavenRepository_Kind + "." + CRDGroupVersion.String()
	LocalMavenRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalMavenRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalMavenRepository{}, &LocalMavenRepositoryList{})
}
