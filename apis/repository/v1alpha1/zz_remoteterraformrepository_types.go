...
type RemoteTerraformRepositoryContentSynchronisationInitParameters struct {
...
type RemoteTerraformRepositoryContentSynchronisationObservation struct {
...
type RemoteTerraformRepositoryContentSynchronisationParameters struct {
...
type RemoteTerraformRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteTerraformRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteTerraformRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteTerraformRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteTerraformRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteTerraformRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteTerraformRepositorySpec defines the desired state of RemoteTerraformRepository
type RemoteTerraformRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteTerraformRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteTerraformRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteTerraformRepositoryStatus defines the observed state of RemoteTerraformRepository.
type RemoteTerraformRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteTerraformRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteTerraformRepository is the Schema for the RemoteTerraformRepositorys API. <no value>
...
type RemoteTerraformRepository struct {
	...
	Spec   RemoteTerraformRepositorySpec   `json:"spec"`
	Status RemoteTerraformRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteTerraformRepositoryList contains a list of RemoteTerraformRepositorys
type RemoteTerraformRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteTerraformRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteTerraformRepository_Kind             = "RemoteTerraformRepository"
	RemoteTerraformRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteTerraformRepository_Kind}.String()
	RemoteTerraformRepository_KindAPIVersion   = RemoteTerraformRepository_Kind + "." + CRDGroupVersion.String()
	RemoteTerraformRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteTerraformRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteTerraformRepository{}, &RemoteTerraformRepositoryList{})
}
