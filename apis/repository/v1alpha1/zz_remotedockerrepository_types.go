...
type RemoteDockerRepositoryInitParameters struct {
...
type RemoteDockerRepositoryObservation struct {
...
type RemoteDockerRepositoryParameters struct {
...
// RemoteDockerRepositorySpec defines the desired state of RemoteDockerRepository
type RemoteDockerRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteDockerRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteDockerRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteDockerRepositoryStatus defines the observed state of RemoteDockerRepository.
type RemoteDockerRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteDockerRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteDockerRepository is the Schema for the RemoteDockerRepositorys API. <no value>
...
type RemoteDockerRepository struct {
	...
	Spec   RemoteDockerRepositorySpec   `json:"spec"`
	Status RemoteDockerRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteDockerRepositoryList contains a list of RemoteDockerRepositorys
type RemoteDockerRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteDockerRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteDockerRepository_Kind             = "RemoteDockerRepository"
	RemoteDockerRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteDockerRepository_Kind}.String()
	RemoteDockerRepository_KindAPIVersion   = RemoteDockerRepository_Kind + "." + CRDGroupVersion.String()
	RemoteDockerRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteDockerRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteDockerRepository{}, &RemoteDockerRepositoryList{})
}
