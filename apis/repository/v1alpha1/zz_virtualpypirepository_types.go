...
type VirtualPyPIRepositoryInitParameters struct {
...
type VirtualPyPIRepositoryObservation struct {
...
type VirtualPyPIRepositoryParameters struct {
...
// VirtualPyPIRepositorySpec defines the desired state of VirtualPyPIRepository
type VirtualPyPIRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualPyPIRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualPyPIRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualPyPIRepositoryStatus defines the observed state of VirtualPyPIRepository.
type VirtualPyPIRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualPyPIRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualPyPIRepository is the Schema for the VirtualPyPIRepositorys API. <no value>
...
type VirtualPyPIRepository struct {
	...
	Spec              VirtualPyPIRepositorySpec   `json:"spec"`
	Status            VirtualPyPIRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualPyPIRepositoryList contains a list of VirtualPyPIRepositorys
type VirtualPyPIRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualPyPIRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualPyPIRepository_Kind             = "VirtualPyPIRepository"
	VirtualPyPIRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualPyPIRepository_Kind}.String()
	VirtualPyPIRepository_KindAPIVersion   = VirtualPyPIRepository_Kind + "." + CRDGroupVersion.String()
	VirtualPyPIRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualPyPIRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualPyPIRepository{}, &VirtualPyPIRepositoryList{})
}
