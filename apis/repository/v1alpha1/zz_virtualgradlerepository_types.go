...
type VirtualGradleRepositoryInitParameters struct {
...
type VirtualGradleRepositoryObservation struct {
...
type VirtualGradleRepositoryParameters struct {
...
// VirtualGradleRepositorySpec defines the desired state of VirtualGradleRepository
type VirtualGradleRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualGradleRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualGradleRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualGradleRepositoryStatus defines the observed state of VirtualGradleRepository.
type VirtualGradleRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualGradleRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualGradleRepository is the Schema for the VirtualGradleRepositorys API. <no value>
...
type VirtualGradleRepository struct {
	...
	Spec              VirtualGradleRepositorySpec   `json:"spec"`
	Status            VirtualGradleRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualGradleRepositoryList contains a list of VirtualGradleRepositorys
type VirtualGradleRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualGradleRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualGradleRepository_Kind             = "VirtualGradleRepository"
	VirtualGradleRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualGradleRepository_Kind}.String()
	VirtualGradleRepository_KindAPIVersion   = VirtualGradleRepository_Kind + "." + CRDGroupVersion.String()
	VirtualGradleRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualGradleRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualGradleRepository{}, &VirtualGradleRepositoryList{})
}
