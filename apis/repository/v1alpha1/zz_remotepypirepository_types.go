...
type RemotePyPIRepositoryContentSynchronisationInitParameters struct {
...
type RemotePyPIRepositoryContentSynchronisationObservation struct {
...
type RemotePyPIRepositoryContentSynchronisationParameters struct {
...
type RemotePyPIRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemotePyPIRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemotePyPIRepositoryObservation struct {
	...
	ContentSynchronisation []RemotePyPIRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemotePyPIRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemotePyPIRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemotePyPIRepositorySpec defines the desired state of RemotePyPIRepository
type RemotePyPIRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemotePyPIRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemotePyPIRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemotePyPIRepositoryStatus defines the observed state of RemotePyPIRepository.
type RemotePyPIRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemotePyPIRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemotePyPIRepository is the Schema for the RemotePyPIRepositorys API. <no value>
...
type RemotePyPIRepository struct {
	...
	Spec   RemotePyPIRepositorySpec   `json:"spec"`
	Status RemotePyPIRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemotePyPIRepositoryList contains a list of RemotePyPIRepositorys
type RemotePyPIRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemotePyPIRepository `json:"items"`
}

// Repository type metadata.
var (
	RemotePyPIRepository_Kind             = "RemotePyPIRepository"
	RemotePyPIRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemotePyPIRepository_Kind}.String()
	RemotePyPIRepository_KindAPIVersion   = RemotePyPIRepository_Kind + "." + CRDGroupVersion.String()
	RemotePyPIRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemotePyPIRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemotePyPIRepository{}, &RemotePyPIRepositoryList{})
}
