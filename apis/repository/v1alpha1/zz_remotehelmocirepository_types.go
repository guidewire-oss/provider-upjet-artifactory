...
type RemoteHelmOCIRepositoryContentSynchronisationInitParameters struct {
...
type RemoteHelmOCIRepositoryContentSynchronisationObservation struct {
...
type RemoteHelmOCIRepositoryContentSynchronisationParameters struct {
...
type RemoteHelmOCIRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteHelmOCIRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteHelmOCIRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteHelmOCIRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteHelmOCIRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteHelmOCIRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteHelmOCIRepositorySpec defines the desired state of RemoteHelmOCIRepository
type RemoteHelmOCIRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteHelmOCIRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteHelmOCIRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteHelmOCIRepositoryStatus defines the observed state of RemoteHelmOCIRepository.
type RemoteHelmOCIRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteHelmOCIRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteHelmOCIRepository is the Schema for the RemoteHelmOCIRepositorys API. <no value>
...
type RemoteHelmOCIRepository struct {
	...
	Spec   RemoteHelmOCIRepositorySpec   `json:"spec"`
	Status RemoteHelmOCIRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteHelmOCIRepositoryList contains a list of RemoteHelmOCIRepositorys
type RemoteHelmOCIRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteHelmOCIRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteHelmOCIRepository_Kind             = "RemoteHelmOCIRepository"
	RemoteHelmOCIRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteHelmOCIRepository_Kind}.String()
	RemoteHelmOCIRepository_KindAPIVersion   = RemoteHelmOCIRepository_Kind + "." + CRDGroupVersion.String()
	RemoteHelmOCIRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteHelmOCIRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteHelmOCIRepository{}, &RemoteHelmOCIRepositoryList{})
}
