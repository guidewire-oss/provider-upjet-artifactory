...
type LocalGenericRepositoryInitParameters struct {
...
type LocalGenericRepositoryObservation struct {
...
type LocalGenericRepositoryParameters struct {
...
// LocalGenericRepositorySpec defines the desired state of LocalGenericRepository
type LocalGenericRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalGenericRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalGenericRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalGenericRepositoryStatus defines the observed state of LocalGenericRepository.
type LocalGenericRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalGenericRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalGenericRepository is the Schema for the LocalGenericRepositorys API. <no value>
...
type LocalGenericRepository struct {
	...
	Spec              LocalGenericRepositorySpec   `json:"spec"`
	Status            LocalGenericRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalGenericRepositoryList contains a list of LocalGenericRepositorys
type LocalGenericRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalGenericRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalGenericRepository_Kind             = "LocalGenericRepository"
	LocalGenericRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalGenericRepository_Kind}.String()
	LocalGenericRepository_KindAPIVersion   = LocalGenericRepository_Kind + "." + CRDGroupVersion.String()
	LocalGenericRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalGenericRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalGenericRepository{}, &LocalGenericRepositoryList{})
}
