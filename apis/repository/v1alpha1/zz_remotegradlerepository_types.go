...
type RemoteGradleRepositoryContentSynchronisationInitParameters struct {
...
type RemoteGradleRepositoryContentSynchronisationObservation struct {
...
type RemoteGradleRepositoryContentSynchronisationParameters struct {
...
type RemoteGradleRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteGradleRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteGradleRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteGradleRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteGradleRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteGradleRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteGradleRepositorySpec defines the desired state of RemoteGradleRepository
type RemoteGradleRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteGradleRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteGradleRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteGradleRepositoryStatus defines the observed state of RemoteGradleRepository.
type RemoteGradleRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteGradleRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteGradleRepository is the Schema for the RemoteGradleRepositorys API. <no value>
...
type RemoteGradleRepository struct {
	...
	Spec   RemoteGradleRepositorySpec   `json:"spec"`
	Status RemoteGradleRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteGradleRepositoryList contains a list of RemoteGradleRepositorys
type RemoteGradleRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteGradleRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteGradleRepository_Kind             = "RemoteGradleRepository"
	RemoteGradleRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteGradleRepository_Kind}.String()
	RemoteGradleRepository_KindAPIVersion   = RemoteGradleRepository_Kind + "." + CRDGroupVersion.String()
	RemoteGradleRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteGradleRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteGradleRepository{}, &RemoteGradleRepositoryList{})
}
