...
type VirtualHelmRepositoryInitParameters struct {
...
type VirtualHelmRepositoryObservation struct {
...
type VirtualHelmRepositoryParameters struct {
...
// VirtualHelmRepositorySpec defines the desired state of VirtualHelmRepository
type VirtualHelmRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VirtualHelmRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider VirtualHelmRepositoryInitParameters `json:"initProvider,omitempty"`
}

// VirtualHelmRepositoryStatus defines the observed state of VirtualHelmRepository.
type VirtualHelmRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VirtualHelmRepositoryObservation `json:"atProvider,omitempty"`
}
...
// VirtualHelmRepository is the Schema for the VirtualHelmRepositorys API. <no value>
...
type VirtualHelmRepository struct {
	...
	Spec              VirtualHelmRepositorySpec   `json:"spec"`
	Status            VirtualHelmRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VirtualHelmRepositoryList contains a list of VirtualHelmRepositorys
type VirtualHelmRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VirtualHelmRepository `json:"items"`
}

// Repository type metadata.
var (
	VirtualHelmRepository_Kind             = "VirtualHelmRepository"
	VirtualHelmRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VirtualHelmRepository_Kind}.String()
	VirtualHelmRepository_KindAPIVersion   = VirtualHelmRepository_Kind + "." + CRDGroupVersion.String()
	VirtualHelmRepository_GroupVersionKind = CRDGroupVersion.WithKind(VirtualHelmRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&VirtualHelmRepository{}, &VirtualHelmRepositoryList{})
}
