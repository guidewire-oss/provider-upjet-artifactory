...
type RemoteGenericRepositoryContentSynchronisationInitParameters struct {
...
type RemoteGenericRepositoryContentSynchronisationObservation struct {
...
type RemoteGenericRepositoryContentSynchronisationParameters struct {
...
type RemoteGenericRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteGenericRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteGenericRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteGenericRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteGenericRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteGenericRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteGenericRepositorySpec defines the desired state of RemoteGenericRepository
type RemoteGenericRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteGenericRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteGenericRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteGenericRepositoryStatus defines the observed state of RemoteGenericRepository.
type RemoteGenericRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteGenericRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteGenericRepository is the Schema for the RemoteGenericRepositorys API. <no value>
...
type RemoteGenericRepository struct {
	...
	Spec   RemoteGenericRepositorySpec   `json:"spec"`
	Status RemoteGenericRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteGenericRepositoryList contains a list of RemoteGenericRepositorys
type RemoteGenericRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteGenericRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteGenericRepository_Kind             = "RemoteGenericRepository"
	RemoteGenericRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteGenericRepository_Kind}.String()
	RemoteGenericRepository_KindAPIVersion   = RemoteGenericRepository_Kind + "." + CRDGroupVersion.String()
	RemoteGenericRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteGenericRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteGenericRepository{}, &RemoteGenericRepositoryList{})
}
