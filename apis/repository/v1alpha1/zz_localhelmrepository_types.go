...
type LocalHelmRepositoryInitParameters struct {
...
type LocalHelmRepositoryObservation struct {
...
type LocalHelmRepositoryParameters struct {
...
// LocalHelmRepositorySpec defines the desired state of LocalHelmRepository
type LocalHelmRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalHelmRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalHelmRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalHelmRepositoryStatus defines the observed state of LocalHelmRepository.
type LocalHelmRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalHelmRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalHelmRepository is the Schema for the LocalHelmRepositorys API. <no value>
...
type LocalHelmRepository struct {
	...
	Spec              LocalHelmRepositorySpec   `json:"spec"`
	Status            LocalHelmRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalHelmRepositoryList contains a list of LocalHelmRepositorys
type LocalHelmRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalHelmRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalHelmRepository_Kind             = "LocalHelmRepository"
	LocalHelmRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalHelmRepository_Kind}.String()
	LocalHelmRepository_KindAPIVersion   = LocalHelmRepository_Kind + "." + CRDGroupVersion.String()
	LocalHelmRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalHelmRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalHelmRepository{}, &LocalHelmRepositoryList{})
}
