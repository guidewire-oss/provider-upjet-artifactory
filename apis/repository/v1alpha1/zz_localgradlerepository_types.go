...
type LocalGradleRepositoryInitParameters struct {
...
type LocalGradleRepositoryObservation struct {
...
type LocalGradleRepositoryParameters struct {
...
// LocalGradleRepositorySpec defines the desired state of LocalGradleRepository
type LocalGradleRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalGradleRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalGradleRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalGradleRepositoryStatus defines the observed state of LocalGradleRepository.
type LocalGradleRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalGradleRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalGradleRepository is the Schema for the LocalGradleRepositorys API. <no value>
...
type LocalGradleRepository struct {
	...
	Spec              LocalGradleRepositorySpec   `json:"spec"`
	Status            LocalGradleRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalGradleRepositoryList contains a list of LocalGradleRepositorys
type LocalGradleRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalGradleRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalGradleRepository_Kind             = "LocalGradleRepository"
	LocalGradleRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalGradleRepository_Kind}.String()
	LocalGradleRepository_KindAPIVersion   = LocalGradleRepository_Kind + "." + CRDGroupVersion.String()
	LocalGradleRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalGradleRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalGradleRepository{}, &LocalGradleRepositoryList{})
}
