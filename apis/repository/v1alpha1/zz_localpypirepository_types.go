...
type LocalPyPIRepositoryInitParameters struct {
...
type LocalPyPIRepositoryObservation struct {
...
type LocalPyPIRepositoryParameters struct {
...
// LocalPyPIRepositorySpec defines the desired state of LocalPyPIRepository
type LocalPyPIRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalPyPIRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalPyPIRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalPyPIRepositoryStatus defines the observed state of LocalPyPIRepository.
type LocalPyPIRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalPyPIRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalPyPIRepository is the Schema for the LocalPyPIRepositorys API. <no value>
...
type LocalPyPIRepository struct {
	...
	Spec              LocalPyPIRepositorySpec   `json:"spec"`
	Status            LocalPyPIRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalPyPIRepositoryList contains a list of LocalPyPIRepositorys
type LocalPyPIRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalPyPIRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalPyPIRepository_Kind             = "LocalPyPIRepository"
	LocalPyPIRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalPyPIRepository_Kind}.String()
	LocalPyPIRepository_KindAPIVersion   = LocalPyPIRepository_Kind + "." + CRDGroupVersion.String()
	LocalPyPIRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalPyPIRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalPyPIRepository{}, &LocalPyPIRepositoryList{})
}
