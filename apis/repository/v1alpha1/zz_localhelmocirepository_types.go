...
type LocalHelmOCIRepositoryInitParameters struct {
	...
	// The maximum number of unique tags of a single OCI object to store in this repository. Once the number tags for an object exceeds this setting, older tags are removed. A value of 0 (default) indicates there is no limit.
...
type LocalHelmOCIRepositoryObservation struct {
...
type LocalHelmOCIRepositoryParameters struct {
...
// LocalHelmOCIRepositorySpec defines the desired state of LocalHelmOCIRepository
type LocalHelmOCIRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalHelmOCIRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalHelmOCIRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalHelmOCIRepositoryStatus defines the observed state of LocalHelmOCIRepository.
type LocalHelmOCIRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalHelmOCIRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalHelmOCIRepository is the Schema for the LocalHelmOCIRepositorys API. <no value>
...
type LocalHelmOCIRepository struct {
	...
	Spec              LocalHelmOCIRepositorySpec   `json:"spec"`
	Status            LocalHelmOCIRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalHelmOCIRepositoryList contains a list of LocalHelmOCIRepositorys
type LocalHelmOCIRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalHelmOCIRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalHelmOCIRepository_Kind             = "LocalHelmOCIRepository"
	LocalHelmOCIRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalHelmOCIRepository_Kind}.String()
	LocalHelmOCIRepository_KindAPIVersion   = LocalHelmOCIRepository_Kind + "." + CRDGroupVersion.String()
	LocalHelmOCIRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalHelmOCIRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalHelmOCIRepository{}, &LocalHelmOCIRepositoryList{})
}
