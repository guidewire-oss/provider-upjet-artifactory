...
type LocalDockerRepositoryInitParameters struct {
...
type LocalDockerRepositoryObservation struct {
...
type LocalDockerRepositoryParameters struct {
...
// LocalDockerRepositorySpec defines the desired state of LocalDockerRepository
type LocalDockerRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     LocalDockerRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LocalDockerRepositoryInitParameters `json:"initProvider,omitempty"`
}

// LocalDockerRepositoryStatus defines the observed state of LocalDockerRepository.
type LocalDockerRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LocalDockerRepositoryObservation `json:"atProvider,omitempty"`
}
...
// LocalDockerRepository is the Schema for the LocalDockerRepositorys API. <no value>
...
type LocalDockerRepository struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              LocalDockerRepositorySpec   `json:"spec"`
	Status            LocalDockerRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LocalDockerRepositoryList contains a list of LocalDockerRepositorys
type LocalDockerRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LocalDockerRepository `json:"items"`
}

// Repository type metadata.
var (
	LocalDockerRepository_Kind             = "LocalDockerRepository"
	LocalDockerRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LocalDockerRepository_Kind}.String()
	LocalDockerRepository_KindAPIVersion   = LocalDockerRepository_Kind + "." + CRDGroupVersion.String()
	LocalDockerRepository_GroupVersionKind = CRDGroupVersion.WithKind(LocalDockerRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&LocalDockerRepository{}, &LocalDockerRepositoryList{})
}
