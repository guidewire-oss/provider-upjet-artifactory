...
type RemoteHelmRepositoryContentSynchronisationInitParameters struct {
...
type RemoteHelmRepositoryContentSynchronisationObservation struct {
...
type RemoteHelmRepositoryContentSynchronisationParameters struct {
...
type RemoteHelmRepositoryInitParameters struct {
	...
	ContentSynchronisation []RemoteHelmRepositoryContentSynchronisationInitParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteHelmRepositoryObservation struct {
	...
	ContentSynchronisation []RemoteHelmRepositoryContentSynchronisationObservation `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
type RemoteHelmRepositoryParameters struct {
	...
	// +kubebuilder:validation:Optional
	ContentSynchronisation []RemoteHelmRepositoryContentSynchronisationParameters `json:"contentSynchronisation,omitempty" tf:"content_synchronisation,omitempty"`
...
// RemoteHelmRepositorySpec defines the desired state of RemoteHelmRepository
type RemoteHelmRepositorySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     RemoteHelmRepositoryParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider RemoteHelmRepositoryInitParameters `json:"initProvider,omitempty"`
}

// RemoteHelmRepositoryStatus defines the observed state of RemoteHelmRepository.
type RemoteHelmRepositoryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        RemoteHelmRepositoryObservation `json:"atProvider,omitempty"`
}
...
// RemoteHelmRepository is the Schema for the RemoteHelmRepositorys API. <no value>
...
type RemoteHelmRepository struct {
	...
	Spec   RemoteHelmRepositorySpec   `json:"spec"`
	Status RemoteHelmRepositoryStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// RemoteHelmRepositoryList contains a list of RemoteHelmRepositorys
type RemoteHelmRepositoryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []RemoteHelmRepository `json:"items"`
}

// Repository type metadata.
var (
	RemoteHelmRepository_Kind             = "RemoteHelmRepository"
	RemoteHelmRepository_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: RemoteHelmRepository_Kind}.String()
	RemoteHelmRepository_KindAPIVersion   = RemoteHelmRepository_Kind + "." + CRDGroupVersion.String()
	RemoteHelmRepository_GroupVersionKind = CRDGroupVersion.WithKind(RemoteHelmRepository_Kind)
)

func init() {
	SchemeBuilder.Register(&RemoteHelmRepository{}, &RemoteHelmRepositoryList{})
}
